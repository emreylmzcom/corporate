...
SECRET_KEY = 'django-insecure-bu3@h_x&315y5ui13ki%x41k8*(s9n#8f_=t9%7u7ufiz-!9rv'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # Add this line to the list of middleware
